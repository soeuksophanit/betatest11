...
// const sectionNavbar = document.querySelector(".navbar-wrap");
// const sectionHero = document.querySelector("#hero");
// const changeTheme = document.querySelector(".dark-mode-icon");
// const sectionHotNews = document.querySelector(".hot-news");
// const sectionLocalNews = document.querySelector(".local-news-wrapper");
// const optional = {
...
//       sectionNavbar.classList.remove("onscrolled");
//     } else {
//       sectionNavbar.classList.add("onscrolled");
//     }
//   });
// }, optional);
...
// const obs3 = new IntersectionObserver((entries, obs) => {
//   entries.forEach((entry) => {
//     if (!entry.isIntersecting) {
//       sectionNavbar.classList.add("onscrolled");
//     } else {
...
// obs2.observe(sectionHotNews);
// // obs3.observe(sectionLocalNews);
